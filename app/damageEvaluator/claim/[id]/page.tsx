...
import Modal from '../../_comopnents/Modal'
import EvaluatorDisplay from '../../_comopnents/Evaluatormodal/EvaluatorDisplay'
...
notFound();
  return (
   ...
   href={`/damageEvaluator/claim/${claim.id}`}>
   ...
   <td>{claim.createdAt?.toDateString()}</td>
      ...
      <td><Modal claimId={parseInt(params.id)}/></td>

      {/* </tbody> */}
  {/* </table> */}

    <div>
      <p className='flex justify-center border-b text-xl font-bold'>Damage Evaluator Varification</p>
    <EvaluatorDisplay claimId={parseInt(params.id)}/>
