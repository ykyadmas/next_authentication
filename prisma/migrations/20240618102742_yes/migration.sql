...
CREATE TABLE `Proposal` (
    ...
    UNIQUE INDEX `Proposal_chassisNo_key`(`chassisNo`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `InsuranceApprove` (
    ...
    UNIQUE INDEX `InsuranceApprove_PaymentId_key`(`PaymentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `InsuranceApprove` ADD CONSTRAINT `InsuranceApprove_PaymentId_fkey` FOREIGN KEY (`PaymentId`) REFERENCES `Payment`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InsuranceApprove` ADD CONSTRAINT `InsuranceApprove_userEmail_fkey` FOREIGN KEY (`userEmail`) REFERENCES `User`(`email`) ON DELETE CASCADE ON UPDATE CASCADE;
